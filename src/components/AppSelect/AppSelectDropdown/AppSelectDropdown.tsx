...
import styles from './AppSelectDropdown.module.scss'; // Adjust extension if needed
...
function AppSelectDropdown<T extends string>({
  value,
  options,
  onSelect,
  onClose,
}: AppSelectDropdownProps<T>): React.ReactElement {
